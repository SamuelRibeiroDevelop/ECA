    ...
    public function tabelapaginada()
    {
     ...
     <tbody>";
            foreach ($dados as $fisherman):
                echo "<tr>
        <td style='text-align: center'>$fisherman->int_id</td>
        ...
        <td style='text-align: center'><a href='?act=upd&id=$fisherman->int_id' title='Alterar'><i class='ti-reload'></i></a></td>
        <td style='text-align: center'><a href='?act=del&id=$fisherman->int_id' title='Remover'><i class='ti-close'></i></a></td>
       </tr>";
            endforeach;
            echo "
</tbody>
